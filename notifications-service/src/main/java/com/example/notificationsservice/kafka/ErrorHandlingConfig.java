...
public class ErrorHandlingConfig {
    ...
    public DefaultErrorHandler errorHandler(KafkaTemplate<String, String> template) {
        DeadLetterPublishingRecoverer recoverer =
                new DeadLetterPublishingRecoverer(template, (record, exception) -> {
                    String topic = record.topic();
                    log.error("DLT publish(notify): topic={} p={} off={} key={} cause={}",
        ...
        handler.setRetryListeners((record, exception, attempt) ->
                log.warn("Retry(notify) {}/? topic={} p={} off={} key={} reason={}",
